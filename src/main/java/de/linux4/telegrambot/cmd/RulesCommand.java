    ...
    public void execute(String command, Message message) throws TelegramApiException {
        if (command.equalsIgnoreCase("rules")) {
            ...
            InlineKeyboardMarkup.InlineKeyboardMarkupBuilder<?, ?> keyboardBuilder = InlineKeyboardMarkup.builder()
                    .keyboardRow(new InlineKeyboardRow(InlineKeyboardButton.builder().text("Rules")
            ...
            if (command.split("_").length > 1) {
                try {
                    ...
                    String chatTitle = instance.telegramClient.execute(GetChat.builder().chatId(chatId.toString())
                            .build()).getTitle();
